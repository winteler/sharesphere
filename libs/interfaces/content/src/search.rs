...
#[cfg(feature = "ssr")]
use {
    sharesphere_core_common::checks::{check_string_length, check_sphere_name, check_sphere_name_with_options, check_username},
    ...
    sharesphere_core_user::user::UserHeader,
