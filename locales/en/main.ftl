...
faq-post-not-visible-answer = Make sure you don't have filters activated that could remove the post. NSFW posts are hidden by default and spoilers can be filtered for a set number of days. Both can be configured in your profile. The post might also have been moderated or deleted.
