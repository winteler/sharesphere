...
use app::forum_management::ssr::{add_rule, delete_forum_category, get_forum_ban_vec, get_forum_category_vec, get_forum_rule_vec, is_user_forum_moderator, load_rule_by_id, remove_rule, remove_user_ban, set_forum_banner_url, set_forum_category, set_forum_icon_url, store_forum_image, update_rule};
...
async fn test_delete_forum_category() -> Result<(), AppError> {
    ...
    // TODO test delete of used category
