...
#[component]
pub fn StacksIcon() -> impl IntoView {
    view! {
...
#[component]
pub fn ScoreUpIcon() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hover:fill-success stroke-success icon icon-tabler icon-tabler-arrow-big-up" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
#[component]
pub fn ScoreDownIcon() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hover:fill-error stroke-error icon icon-tabler icon-tabler-arrow-big-down" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
